        ...
        <div className="w-full flex justify-between max-lg:flex-col gap-12">
          ...
          <div className="lg:w-1/2 w-full flex max-mdx:gap-5">
            <div className="flex-1 flex flex-col text-sm gap-4 font-semibold">
              ...
              <a href="/categories/catalog/ultrasound-diagnostic-systems">Ultrasound Diagnostic System</a>
              <a href="/categories/catalog/laboratory-equipment">Laboratory Equipment</a>
              <a href="/categories/catalog/reagents-and-consumables">Reagents and Consumables</a>
              <a href="/categories/catalog/radiology-and-xray-systems">Radiology/X-ray systems</a>
              <a
                href="/categories"
